...
for(let i = 0; i < 512; i++) {
  ...
  v = rotate(v);
  if(!operations.has(v)) { operations.set(v, { op: "rotate_x2", i }); }
  v = rotate(v);
  if(!operations.has(v)) { operations.set(v, { op: "rotate_x3", i }); }
  ...
  v = rotate(v);
  if(!operations.has(v)) { operations.set(v, { op: "flip,rotate_x2", i }); }
  v = rotate(v);
  if(!operations.has(v)) { operations.set(v, { op: "flip,rotate_x3", i }); }
}

const b = Array.from(operations).filter(v => typeof v[1] === 'number');
